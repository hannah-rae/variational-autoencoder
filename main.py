...
VALIDATION_FILE = './tmp/data/validation.tfrecords'
...
class LatentAttention():
    ...
    def train(self):
        ...
        # reshaped_vis = visualization.reshape(self.batchsize, FLAGS.input_rows, FLAGS.input_cols)
        # # Reshape into a grid and save it as a reference, only 64 of them
        ...
        try:
          ...
          while not coord.should_stop():
            ...
            # # Save the first input images
            # if step == 2:
            #     input_images = tf.image.encode_png(self.images)
            #     savename = 'inputim.png'
            #     cv2.imwrite(savename, input_images)
        ...
        #         self.saver.save(sess, os.getcwd()+"/training/train",global_step=epoch)
        #         generated_test = sess.run(self.generated_images, feed_dict={self.images: visualization})
        #         generated_test = generated_test.reshape(self.batchsize, FLAGS.input_rows, FLAGS.input_cols)
