...
flags.DEFINE_integer('input_filters', 1, 'Number of filters in input images')
...
flags.DEFINE_integer('C1', 256, 'Number of feature maps in first conv layer')
flags.DEFINE_integer('C2', 128, 'Number of feature maps in second conv layer')
...
flags.DEFINE_integer('kernel_size_c1', 3, 'Kernel size for first convolutional layer')
flags.DEFINE_integer('kernel_size_c2', 3, 'Kernel size for second convolutional layer')
flags.DEFINE_integer('stride_size', 1, 'Stride size for all convolutions')
flags.DEFINE_string('log_dir', '/home/hannah/src/MastcamVAE/log', 'Directory to store training checkpoints')
...
flags.DEFINE_string('tmp_dir', '/Users/hannahrae/src/autoencoder/MastcamVAE/tmp/data', 'Directory to download data files and write the converted result')
flags.DEFINE_string('train_records', '/home/hannah/src/MastcamVAE/tmp/data/train.tfrecords', 'Directory on local machine or GCS where TFRecords for training located')
flags.DEFINE_string('test_records', '/home/hannah/src/MastcamVAE/tmp/data/test.tfrecords', 'Directory on local machine or GCS where TFRecords for testing located')
